...
#include "engines/amethyst_tapered.h"
...
using TuneEval = Toy::AmethystEvalTapered;
...
constexpr int32_t learning_rate_drop_interval = 1500;
constexpr tune_t learning_rate_drop_ratio = 0.7;
